            ...
            with st.spinner("Yanıtlanıyor..."):
                try:
                    ...
                    if not context.strip():
                        ...
                        12. ERASMUS SORULARI ÖZEL KURALI: Kullanıcı "Erasmus" ile ilgili genel bir soru sorduğunda, eğer BAĞLAMDA öğrenim hareketliliğinin OLMADIĞI yazıyorsa, cevaba KESİNLİKLE "Bilgisayar Programcılığı programında anlaşmalı üniversite bulunmadığı için Öğrenim Hareketliliği yoktur" bilgisini vererek başla. Ardından öğrencilerin yararlanabileceği tek seçenek olan "Erasmus+ Staj Hareketliliği" detaylarını açıkla.
